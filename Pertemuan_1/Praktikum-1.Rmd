...
# Membaca file Excel
data_excel <- read_excel("D:\\My Documents\\Downloads\\Data-excel-pertemuan-1.xlsx")
```
...
```{r}
# Membaca file CSV
data_csv <- read.csv("D:\\My Documents\\Downloads\\Data csv pertemuan 1.csv", sep = ";")
dataaa <- read.csv2("D:\\My Documents\\Downloads\\Data csv pertemuan 1.csv")
```
...
write_xlsx(data_baru, "data.xlsx")
```
